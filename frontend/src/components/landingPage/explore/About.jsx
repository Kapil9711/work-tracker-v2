...
const Section = styled.section`
  & .shadow {
    box-shadow: -5px 6px 18px -3px #edac70;
  }
`;
...
const About = () => {
  ...
  return (
    <Section
      // style={{ height: "min(100vh,763px)" }}
      id="about"
      className="sm:relative sm:container pb-40 sm:gap-16 sm:flex sm:items-center sm:flex-col h-[780px]  mx-auto  about"
    >
